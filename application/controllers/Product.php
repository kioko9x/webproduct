...
Class Product extends MY_Controller
{
    ...
    function search()
    {
        ...
        // Viet cau lenh tim kiem, tim san pham co ten tieng viet hoac khong dau phu hop voi tu khoa
        $query = 'name: '.$key.' OR name_en: '.$key;
        ...
        foreach ($hits as $i => $hit)
        {
            ...
            $row = $this->product_model->get_info($row->id);
            if(!$row) continue;
            $list[] = $row;
        }
