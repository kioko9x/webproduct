        ...
        <!-- The Ads -->
	       <div class="box-right">
			    ...
			    <div class="content-box">
			        <a href="">
					     <img src="<?php echo public_url()?>/site/images/quangcao.png">
					</a>
			    </div>
		   </div>
		<!-- End Ads -->
		 ...
		 <!-- The Fanpage -->
	       <div class="box-right">
			    ...
			    <div class="content-box">
			         <iframe src="http://www.facebook.com/plugins/likebox.php?href=https://www.facebook.com/kobeodau94&amp;width=190&amp;height=282&amp;show_faces=true&amp;colorscheme=light&amp;stream=false&amp;border_color&amp;header=true" scrolling="no" style="border:none; overflow:hidden; width:190px; height:300px;" allowtransparency="true" frameborder="0">
	                 </iframe>
		 ...
		 <!-- The Fanpage -->
	       <div class="box-right">
			    ...
			    <div class="content-box">
					...
					</script><div id="histats_counter_456" style="display: block;"><a href="http://www.histats.com/viewstats/?sid=2138481&amp;ccid=401" target="_blank"><canvas id="histats_counter_456_canvas" width="119" height="0"></canvas></a></div></a>
